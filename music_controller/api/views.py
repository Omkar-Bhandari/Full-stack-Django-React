...
class GetRoom(APIView):
    ...
    def get(self,request,format=None):
        ...
        return Response({'Bad Requwst : Code Parameter Not Found'}, status=status.HTTP_400_BAD_REQUEST)
...
class JoinRoom(APIView):
    ...
    def post(self,request,format=None):
        ...
        if code != None:
            ...
            return Response({'Invalid Code':'Room with Code Not Found'},status=status.HTTP_404_NOT_FOUND)
